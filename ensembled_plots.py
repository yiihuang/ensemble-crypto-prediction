...
def plot_bagging():
    ...
    plt.savefig('output/bagging_plot.png', dpi=300, bbox_inches='tight')
    print("Saved bagging plot to bagging_plot.png")
...
def plot_boosting():
    ...
    plt.savefig('output/boosting_plot.png', dpi=300, bbox_inches='tight')
    print("Saved boosting plot to boosting_plot.png")
...
def plot_stacking():
    ...
    plt.savefig('output/stacking_plot.png', dpi=300, bbox_inches='tight')
    print("Saved stacking plot to stacking_plot.png")
...
def plot_voting():
    ...
    plt.savefig('output/voting_plot.png', dpi=300, bbox_inches='tight')
    print("Saved voting plot to voting_plot.png")
